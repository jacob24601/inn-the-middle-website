          ...
          <div className="flex flex-col justify-center p-8 md:p-12">
            <div>
              ...
              <p className="text-medium">
                Your story matters. Share your experience and help others
                discover Inn The Middle.
              </p>
            </div>
            <div className="mt-6 flex flex-wrap items-center gap-4 md:mt-8">
              <Button title="Review" asChild>
                <a
              ...
              <Button title="Call us" variant="secondary" asChild>
